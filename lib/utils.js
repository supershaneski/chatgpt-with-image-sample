...
/**
 * Removes trailing commas from JSON output of function calling
...
/**
 * Truncates text if it exceeds length and adds ellipsis
 * @param {String} text 
 * @param {Integer} length 
 * @returns {String}
 */
export function truncateText(text, length = 16) {
